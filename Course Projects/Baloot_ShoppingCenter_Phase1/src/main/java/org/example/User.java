...
public class User {
    ...
    private List<Integer> User_Purchased_List = new ArrayList<>();
    ...
    public List<Integer> get_User_Purchased_List(){ return User_Purchased_List; }
    ...
    public void add_commodity_to_user_purchased_list(int Commodity_id){
        for (int index_of_User_Purchased_List = 0; index_of_User_Purchased_List < User_Purchased_List.size(); index_of_User_Purchased_List++)
            if (User_Purchased_List.get(index_of_User_Purchased_List) == Commodity_id) {
                System.out.println("Commodity is available in your purchased list");
                return;
            }
        User_Purchased_List.add(Commodity_id);
    }
