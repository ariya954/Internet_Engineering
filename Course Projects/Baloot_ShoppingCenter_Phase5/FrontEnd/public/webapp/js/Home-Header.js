...
function HomeHeader(props) {
    ...
    function search_commodity_event_handler(){
        window.location.href = "commodities?" + document.getElementById("search_subject").textContent + "=" + document.getElementById("search_input").value + "&username=" + props.current_logged_in_username;
    };
