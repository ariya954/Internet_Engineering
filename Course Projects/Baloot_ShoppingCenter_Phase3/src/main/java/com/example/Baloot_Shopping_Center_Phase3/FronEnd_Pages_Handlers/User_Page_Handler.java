...
import com.example.Baloot_Shopping_Center_Phase3.Purchased_List;
...
public class User_Page_Handler {
    public String Response(String username, int credit_to_added, boolean pay) throws IOException {
                                            ...
                                            Response +=
                                                    "<tr>" +
                                                            ...
                                                            "<script type=\"text/babel\">" +
                                                                "ReactDOM.render(<BuyListItem buy_list_item_id=\"" + user_buy_list.get(buy_list_item).Commodity  + "\" number_of_buy_list_item_in_cart=\"" + user_buy_list.get(buy_list_item).in_cart + "\"/>, document.getElementById(\'buy-list-item" + buy_list_item + "\'));" +
                                                            "</script>" +
                                                    "</tr>";
                                        }
                                        Response +=
